...
namespace T3DNetFramework.Generated.Classes.Sim {
    ...
    public unsafe class VehicleBlocker : SceneObject {
        ...
        public VehicleBlocker(string pName, bool pRegister) 
            : this(false) {
            Name = pName;
            if (pRegister) {
                RegisterObject();
        ...
        public VehicleBlocker(string pName) 
            : this(pName, false) {
        }
        ...
        public VehicleBlocker(SimObject pObj) 
            : base(pObj) {
        }
        
        public VehicleBlocker(IntPtr pObj) 
            : base(pObj) {
        }
                    ...
                    _StaticGetTypeFunc =
                        (_StaticGetType)Marshal.GetDelegateForFunctionPointer(
                            Torque3D.DllLoadUtils.GetProcAddress(
                                ...
                                "fnVehicleBlocker_staticGetType"), typeof(_StaticGetType));
                }
                ...
                if (_CreateFunc == null) {
                    _CreateFunc =
                        (_Create)Marshal.GetDelegateForFunctionPointer(
                            Torque3D.DllLoadUtils.GetProcAddress(
                                Torque3D.Torque3DLibHandle,
                                "fnVehicleBlocker_create"), typeof(_Create));
                }
