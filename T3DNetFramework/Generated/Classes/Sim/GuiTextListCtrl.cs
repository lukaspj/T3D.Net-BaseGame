...
namespace T3DSharpFramework.Generated.Classes.Sim {    
    ...
    public unsafe class GuiTextListCtrl : GuiArrayCtrl {
        ...
        new internal struct InternalUnsafeMethods {
                ...
                //internal delegate bool _IsRowActive(IntPtr _this, int rowNum);
                ...
                //internal delegate void _SetRowActive(IntPtr _this, int rowNum, [MarshalAs(UnmanagedType.I1)]bool active);
                ...
                //internal delegate int _FindTextIndex(IntPtr _this, string needle);
                ...
                //internal delegate void _ScrollVisible(IntPtr _this, int rowNum);
                ...
                //internal delegate void _RemoveRow(IntPtr _this, int index);
                ...
                //internal delegate void _RemoveRowById(IntPtr _this, int id);
                ...
                //internal delegate IntPtr _GetRowText(IntPtr _this, int index);
                ...
                //internal delegate int _GetRowNumById(IntPtr _this, int id);
                ...
                //internal delegate IntPtr _GetRowTextById(IntPtr _this, int id);
                ...
                //internal delegate int _GetRowId(IntPtr _this, int index);
                ...
                //internal delegate int _RowCount(IntPtr _this);
                ...
                //internal delegate void _SortNumerical(IntPtr _this, int columnID, [MarshalAs(UnmanagedType.I1)]bool increasing);
                ...
                //internal delegate void _Sort(IntPtr _this, int columnId, [MarshalAs(UnmanagedType.I1)]bool increasing);
                ...
                //internal delegate void _SetRowById(IntPtr _this, int id, string text);
                ...
                //internal delegate int _AddRow(IntPtr _this, int id, string text, int index);
                ...
                //internal delegate void _SetSelectedRow(IntPtr _this, int rowNum);
                ...
                //internal delegate void _SetSelectedById(IntPtr _this, int id);
                ...
                //internal delegate int _GetSelectedId(IntPtr _this);
                ...
                //internal delegate void _OnDeleteKey(IntPtr _this, int id);
                ...
                //internal delegate void _OnSelect(IntPtr _this, int cellid, string text);
