...
namespace T3DSharpFramework.Generated.Classes.Sim {    
    ...
    public unsafe class ForcedMaterialMeshMgr : RenderMeshMgr {
        ...
        public ForcedMaterialMeshMgr(string pName, bool pRegister) 
            : this(false) {
            Name = pName;
            if (pRegister) {
                RegisterObject();
        ...
        public ForcedMaterialMeshMgr(string pName) 
            : this(pName, false) {
        }
        ...
        public ForcedMaterialMeshMgr(SimObject pObj) 
            : base(pObj) {
        }
        
        public ForcedMaterialMeshMgr(IntPtr pObj) 
            : base(pObj) {
        }
                        ...
                        _StaticGetTypeFunc =
                            (_StaticGetType)Marshal.GetDelegateForFunctionPointer(
                                Torque3D.DllLoadUtils.GetProcAddress(
                                    ...
                                    "fnForcedMaterialMeshMgr_staticGetType"), typeof(_StaticGetType));
                    }
                    ...
                    if (_CreateFunc == null) {
                        _CreateFunc =
                            (_Create)Marshal.GetDelegateForFunctionPointer(
                                Torque3D.DllLoadUtils.GetProcAddress(
                                    Torque3D.Torque3DLibHandle,
                                    "fnForcedMaterialMeshMgr_create"), typeof(_Create));
                    }
