...
namespace T3DNetFramework.Generated.Classes.Sim {
    ...
    public unsafe class GuiInspectorTypeSFXEnvironmentName : GuiInspectorDatablockField {
        ...
        public GuiInspectorTypeSFXEnvironmentName(string pName, bool pRegister) 
            : this(false) {
            Name = pName;
            if (pRegister) {
                RegisterObject();
        ...
        public GuiInspectorTypeSFXEnvironmentName(string pName) 
            : this(pName, false) {
        }
        ...
        public GuiInspectorTypeSFXEnvironmentName(SimObject pObj) 
            : base(pObj) {
        }
        
        public GuiInspectorTypeSFXEnvironmentName(IntPtr pObj) 
            : base(pObj) {
        }
                    ...
                    _StaticGetTypeFunc =
                        (_StaticGetType)Marshal.GetDelegateForFunctionPointer(
                            Torque3D.DllLoadUtils.GetProcAddress(
                                ...
                                "fnGuiInspectorTypeSFXEnvironmentName_staticGetType"), typeof(_StaticGetType));
                }
                ...
                if (_CreateFunc == null) {
                    _CreateFunc =
                        (_Create)Marshal.GetDelegateForFunctionPointer(
                            Torque3D.DllLoadUtils.GetProcAddress(
                                Torque3D.Torque3DLibHandle,
                                "fnGuiInspectorTypeSFXEnvironmentName_create"), typeof(_Create));
                }
