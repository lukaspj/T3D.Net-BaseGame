...
namespace T3DNetFramework.Generated.Classes.Sim {
    ...
    public unsafe class CameraData : ShapeBaseData {
        ...
        public CameraData(string pName, bool pRegister) 
            : this(false) {
            Name = pName;
            if (pRegister) {
                RegisterObject();
        ...
        public CameraData(string pName) 
            : this(pName, false) {
        }
        ...
        public CameraData(SimObject pObj) 
            : base(pObj) {
        }
        
        public CameraData(IntPtr pObj) 
            : base(pObj) {
        }
                    ...
                    _StaticGetTypeFunc =
                        (_StaticGetType)Marshal.GetDelegateForFunctionPointer(
                            Torque3D.DllLoadUtils.GetProcAddress(
                                ...
                                "fnCameraData_staticGetType"), typeof(_StaticGetType));
                }
                ...
                if (_CreateFunc == null) {
                    _CreateFunc =
                        (_Create)Marshal.GetDelegateForFunctionPointer(
                            Torque3D.DllLoadUtils.GetProcAddress(
                                Torque3D.Torque3DLibHandle,
                                "fnCameraData_create"), typeof(_Create));
                }
