...
namespace T3DSharpFramework.Generated.Classes.Sim {    
    ...
    public unsafe class AutoloadAssets : SimObject {
        ...
        public AutoloadAssets(string pName, bool pRegister) 
            : this(false) {
            Name = pName;
            if (pRegister) {
                RegisterObject();
        ...
        public AutoloadAssets(string pName) 
            : this(pName, false) {
        }
        ...
        public AutoloadAssets(SimObject pObj) 
            : base(pObj) {
        }
        
        public AutoloadAssets(IntPtr pObj) 
            : base(pObj) {
        }
                        ...
                        _StaticGetTypeFunc =
                            (_StaticGetType)Marshal.GetDelegateForFunctionPointer(
                                Torque3D.DllLoadUtils.GetProcAddress(
                                    ...
                                    "fnAutoloadAssets_staticGetType"), typeof(_StaticGetType));
                    }
                    ...
                    if (_CreateFunc == null) {
                        _CreateFunc =
                            (_Create)Marshal.GetDelegateForFunctionPointer(
                                Torque3D.DllLoadUtils.GetProcAddress(
                                    Torque3D.Torque3DLibHandle,
                                    "fnAutoloadAssets_create"), typeof(_Create));
                    }
