...
namespace T3DNetFramework.Generated.Classes.Sim {
    ...
    public unsafe class DecalManager : SceneObject {
        ...
        public DecalManager(string pName, bool pRegister) 
            : this(false) {
            Name = pName;
            if (pRegister) {
                RegisterObject();
        ...
        public DecalManager(string pName) 
            : this(pName, false) {
        }
        ...
        public DecalManager(SimObject pObj) 
            : base(pObj) {
        }
        
        public DecalManager(IntPtr pObj) 
            : base(pObj) {
        }
                    ...
                    _StaticGetTypeFunc =
                        (_StaticGetType)Marshal.GetDelegateForFunctionPointer(
                            Torque3D.DllLoadUtils.GetProcAddress(
                                ...
                                "fnDecalManager_staticGetType"), typeof(_StaticGetType));
                }
                ...
                if (_CreateFunc == null) {
                    _CreateFunc =
                        (_Create)Marshal.GetDelegateForFunctionPointer(
                            Torque3D.DllLoadUtils.GetProcAddress(
                                Torque3D.Torque3DLibHandle,
                                "fnDecalManager_create"), typeof(_Create));
                }
