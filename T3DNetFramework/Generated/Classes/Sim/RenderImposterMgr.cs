...
namespace T3DNetFramework.Generated.Classes.Sim {
    /// <summary>A render bin for batch rendering imposters.</summary>
    /// <description>
    ...
    public unsafe class RenderImposterMgr : RenderBinManager {
        ...
        public RenderImposterMgr(string pName, bool pRegister) 
            : this(false) {
            Name = pName;
            if (pRegister) {
                RegisterObject();
        ...
        public RenderImposterMgr(string pName) 
            : this(pName, false) {
        }
        ...
        public RenderImposterMgr(IntPtr pObj) 
            : base(pObj) {
        }
                    ...
                    _StaticGetTypeFunc =
                        (_StaticGetType)Marshal.GetDelegateForFunctionPointer(
                            Torque3D.DllLoadUtils.GetProcAddress(
                                ...
                                "fnRenderImposterMgr_staticGetType"), typeof(_StaticGetType));
                }
                ...
                if (_CreateFunc == null) {
                    _CreateFunc =
                        (_Create)Marshal.GetDelegateForFunctionPointer(
                            Torque3D.DllLoadUtils.GetProcAddress(
                                Torque3D.Torque3DLibHandle,
                                "fnRenderImposterMgr_create"), typeof(_Create));
                }
        ...
        /// <description>
        /// Get the type info object for the RenderImposterMgr class.
        /// </description>
        /// <returns>The type info object for RenderImposterMgr</returns>
