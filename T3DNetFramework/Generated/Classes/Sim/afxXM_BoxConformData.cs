...
namespace T3DNetFramework.Generated.Classes.Sim {
    ...
    public unsafe class afxXM_BoxConformData : afxXM_BaseData {
        ...
        public afxXM_BoxConformData(string pName, bool pRegister)
            : this(false) {
            Name = pName;
            if (pRegister) {
                RegisterObject();
        ...
        public afxXM_BoxConformData(string pName)
            : this(pName, false) {
        }
        ...
        public afxXM_BoxConformData(SimObject pObj)
            : base(pObj) {
        }

        public afxXM_BoxConformData(IntPtr pObj)
            : base(pObj) {
        }
                        ...
                        _StaticGetTypeFunc =
                            (_StaticGetType)Marshal.GetDelegateForFunctionPointer(
                                Torque3D.DllLoadUtils.GetProcAddress(
                                    ...
                                    "fnafxXM_BoxConformData_staticGetType"), typeof(_StaticGetType));
                    }
                    ...
                    if (_CreateFunc == null) {
                        _CreateFunc =
                            (_Create)Marshal.GetDelegateForFunctionPointer(
                                Torque3D.DllLoadUtils.GetProcAddress(
                                    Torque3D.Torque3DLibHandle,
                                    "fnafxXM_BoxConformData_create"), typeof(_Create));
                    }
