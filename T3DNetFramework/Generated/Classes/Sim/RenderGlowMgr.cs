...
namespace T3DNetFramework.Generated.Classes.Sim {    
    public unsafe class RenderGlowMgr : RenderTexTargetBinManager {
        ...
        public RenderGlowMgr(string pName, bool pRegister) 
            : this(false) {
            Name = pName;
            if (pRegister) {
                RegisterObject();
        ...
        public RenderGlowMgr(string pName) 
            : this(pName, false) {
        }
        ...
        public RenderGlowMgr(SimObject pObj) 
            : base(pObj) {
        }
        
        public RenderGlowMgr(IntPtr pObj) 
            : base(pObj) {
        }
                    ...
                    _StaticGetTypeFunc =
                        (_StaticGetType)Marshal.GetDelegateForFunctionPointer(
                            Torque3D.DllLoadUtils.GetProcAddress(
                                ...
                                "fnRenderGlowMgr_staticGetType"), typeof(_StaticGetType));
                }
                ...
                if (_CreateFunc == null) {
                    _CreateFunc =
                        (_Create)Marshal.GetDelegateForFunctionPointer(
                            Torque3D.DllLoadUtils.GetProcAddress(
                                Torque3D.Torque3DLibHandle,
                                "fnRenderGlowMgr_create"), typeof(_Create));
                }
