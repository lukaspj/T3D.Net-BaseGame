...
namespace T3DNetFramework.Generated.Classes.Sim {    
    public unsafe class Vehicle : ShapeBase {
        ...
        public Vehicle(string pName, bool pRegister) 
            : this(false) {
            Name = pName;
            if (pRegister) {
                RegisterObject();
        ...
        public Vehicle(SimObject pObj) 
            : base(pObj) {
        }
        
        public Vehicle(IntPtr pObj) 
            : base(pObj) {
        }
                    ...
                    _StaticGetTypeFunc =
                        (_StaticGetType)Marshal.GetDelegateForFunctionPointer(
                            Torque3D.DllLoadUtils.GetProcAddress(
                                ...
                                "fnVehicle_staticGetType"), typeof(_StaticGetType));
                }
                ...
                if (_CreateFunc == null) {
                    _CreateFunc =
                        (_Create)Marshal.GetDelegateForFunctionPointer(
                            Torque3D.DllLoadUtils.GetProcAddress(
                                Torque3D.Torque3DLibHandle,
                                "fnVehicle_create"), typeof(_Create));
                }
