...
namespace T3DNetFramework.Generated.Classes.Sim {
    ...
    public unsafe class RenderObjectMgr : RenderBinManager {
        ...
        public RenderObjectMgr(string pName, bool pRegister) 
            : this(false) {
            Name = pName;
            if (pRegister) {
                RegisterObject();
        ...
        public RenderObjectMgr(string pName) 
            : this(pName, false) {
        }
        ...
        public RenderObjectMgr(SimObject pObj) 
            : base(pObj) {
        }
        
        public RenderObjectMgr(IntPtr pObj) 
            : base(pObj) {
        }
                    ...
                    _StaticGetTypeFunc =
                        (_StaticGetType)Marshal.GetDelegateForFunctionPointer(
                            Torque3D.DllLoadUtils.GetProcAddress(
                                ...
                                "fnRenderObjectMgr_staticGetType"), typeof(_StaticGetType));
                }
                ...
                if (_CreateFunc == null) {
                    _CreateFunc =
                        (_Create)Marshal.GetDelegateForFunctionPointer(
                            Torque3D.DllLoadUtils.GetProcAddress(
                                Torque3D.Torque3DLibHandle,
                                "fnRenderObjectMgr_create"), typeof(_Create));
                }
        ...
        /// <description>
        /// Get the type info object for the RenderObjectMgr class.
        /// </description>
        /// <returns>The type info object for RenderObjectMgr</returns>
