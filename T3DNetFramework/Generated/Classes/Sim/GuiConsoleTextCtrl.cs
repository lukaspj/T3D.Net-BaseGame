...
namespace T3DNetFramework.Generated.Classes.Sim {    
    public unsafe class GuiConsoleTextCtrl : GuiControl {
        ...
        public GuiConsoleTextCtrl(string pName, bool pRegister) 
            : this(false) {
            Name = pName;
            if (pRegister) {
                RegisterObject();
        ...
        public GuiConsoleTextCtrl(string pName) 
            : this(pName, false) {
        }
        ...
        public GuiConsoleTextCtrl(SimObject pObj) 
            : base(pObj) {
        }
        
        public GuiConsoleTextCtrl(IntPtr pObj) 
            : base(pObj) {
        }
                    ...
                    _StaticGetTypeFunc =
                        (_StaticGetType)Marshal.GetDelegateForFunctionPointer(
                            Torque3D.DllLoadUtils.GetProcAddress(
                                ...
                                "fnGuiConsoleTextCtrl_staticGetType"), typeof(_StaticGetType));
                }
                ...
                if (_CreateFunc == null) {
                    _CreateFunc =
                        (_Create)Marshal.GetDelegateForFunctionPointer(
                            Torque3D.DllLoadUtils.GetProcAddress(
                                Torque3D.Torque3DLibHandle,
                                "fnGuiConsoleTextCtrl_create"), typeof(_Create));
                }
