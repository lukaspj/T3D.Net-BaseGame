...
namespace T3DNetFramework.Generated.Classes.Sim {    
    public unsafe class GuiBitmapButtonTextCtrl : GuiBitmapButtonCtrl {
        ...
        public GuiBitmapButtonTextCtrl(string pName, bool pRegister) 
            : this(false) {
            Name = pName;
            if (pRegister) {
                RegisterObject();
        ...
        public GuiBitmapButtonTextCtrl(string pName) 
            : this(pName, false) {
        }
        ...
        public GuiBitmapButtonTextCtrl(SimObject pObj) 
            : base(pObj) {
        }
        
        public GuiBitmapButtonTextCtrl(IntPtr pObj) 
            : base(pObj) {
        }
                    ...
                    _StaticGetTypeFunc =
                        (_StaticGetType)Marshal.GetDelegateForFunctionPointer(
                            Torque3D.DllLoadUtils.GetProcAddress(
                                ...
                                "fnGuiBitmapButtonTextCtrl_staticGetType"), typeof(_StaticGetType));
                }
