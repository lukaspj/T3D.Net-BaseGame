...
namespace T3DNetFramework.Generated.Classes.Sim {
    ...
    public unsafe class afxXM_ScaleData : afxXM_WeightedBaseData {
        ...
        public afxXM_ScaleData(string pName, bool pRegister) 
            : this(false) {
            Name = pName;
            if (pRegister) {
                RegisterObject();
        ...
        public afxXM_ScaleData(string pName) 
            : this(pName, false) {
        }
        ...
        public afxXM_ScaleData(SimObject pObj) 
            : base(pObj) {
        }
        
        public afxXM_ScaleData(IntPtr pObj) 
            : base(pObj) {
        }
                    ...
                    _StaticGetTypeFunc =
                        (_StaticGetType)Marshal.GetDelegateForFunctionPointer(
                            Torque3D.DllLoadUtils.GetProcAddress(
                                ...
                                "fnafxXM_ScaleData_staticGetType"), typeof(_StaticGetType));
                }
                ...
                if (_CreateFunc == null) {
                    _CreateFunc =
                        (_Create)Marshal.GetDelegateForFunctionPointer(
                            Torque3D.DllLoadUtils.GetProcAddress(
                                Torque3D.Torque3DLibHandle,
                                "fnafxXM_ScaleData_create"), typeof(_Create));
                }
        ...
        /// <description>
        /// Get the type info object for the afxXM_ScaleData class.
        /// </description>
        /// <returns>The type info object for afxXM_ScaleData</returns>
