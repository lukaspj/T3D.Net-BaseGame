...
namespace T3DNetFramework.Generated.Classes.Sim {
    ...
    public unsafe class afxConsoleMessageData : GameBaseData {
        ...
        public afxConsoleMessageData(string pName, bool pRegister)
            : this(false) {
            Name = pName;
            if (pRegister) {
                RegisterObject();
        ...
        public afxConsoleMessageData(string pName)
            : this(pName, false) {
        }
        ...
        public afxConsoleMessageData(SimObject pObj)
            : base(pObj) {
        }

        public afxConsoleMessageData(IntPtr pObj)
            : base(pObj) {
        }
                        ...
                        _StaticGetTypeFunc =
                            (_StaticGetType)Marshal.GetDelegateForFunctionPointer(
                                Torque3D.DllLoadUtils.GetProcAddress(
                                    ...
                                    "fnafxConsoleMessageData_staticGetType"), typeof(_StaticGetType));
                    }
                    ...
                    if (_CreateFunc == null) {
                        _CreateFunc =
                            (_Create)Marshal.GetDelegateForFunctionPointer(
                                Torque3D.DllLoadUtils.GetProcAddress(
                                    Torque3D.Torque3DLibHandle,
                                    "fnafxConsoleMessageData_create"), typeof(_Create));
                    }
