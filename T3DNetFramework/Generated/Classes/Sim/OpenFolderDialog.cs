...
namespace T3DNetFramework.Generated.Classes.Sim {
    ...
    public unsafe class OpenFolderDialog : OpenFileDialog {
        ...
        public OpenFolderDialog(string pName, bool pRegister)
            : this(false) {
            Name = pName;
            if (pRegister) {
                RegisterObject();
        ...
        public OpenFolderDialog(string pName)
            : this(pName, false) {
        }
        ...
        public OpenFolderDialog(SimObject pObj)
            : base(pObj) {
        }

        public OpenFolderDialog(IntPtr pObj)
            : base(pObj) {
        }
                        ...
                        _StaticGetTypeFunc =
                            (_StaticGetType)Marshal.GetDelegateForFunctionPointer(
                                Torque3D.DllLoadUtils.GetProcAddress(
                                    ...
                                    "fnOpenFolderDialog_staticGetType"), typeof(_StaticGetType));
                    }
                    ...
                    if (_CreateFunc == null) {
                        _CreateFunc =
                            (_Create)Marshal.GetDelegateForFunctionPointer(
                                Torque3D.DllLoadUtils.GetProcAddress(
                                    Torque3D.Torque3DLibHandle,
                                    "fnOpenFolderDialog_create"), typeof(_Create));
                    }
