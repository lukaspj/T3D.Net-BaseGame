...
namespace T3DNetFramework.Generated.Classes.Sim {
    ...
    public unsafe class afxXM_BaseData : GameBaseData {
        ...
        public afxXM_BaseData(string pName, bool pRegister) 
            : this(false) {
            Name = pName;
            if (pRegister) {
                RegisterObject();
        ...
        public afxXM_BaseData(string pName) 
            : this(pName, false) {
        }
        ...
        public afxXM_BaseData(SimObject pObj) 
            : base(pObj) {
        }
        
        public afxXM_BaseData(IntPtr pObj) 
            : base(pObj) {
        }
                    ...
                    _StaticGetTypeFunc =
                        (_StaticGetType)Marshal.GetDelegateForFunctionPointer(
                            Torque3D.DllLoadUtils.GetProcAddress(
                                ...
                                "fnafxXM_BaseData_staticGetType"), typeof(_StaticGetType));
                }
                ...
                if (_CreateFunc == null) {
                    _CreateFunc =
                        (_Create)Marshal.GetDelegateForFunctionPointer(
                            Torque3D.DllLoadUtils.GetProcAddress(
                                Torque3D.Torque3DLibHandle,
                                "fnafxXM_BaseData_create"), typeof(_Create));
                }
        ...
        /// <description>
        /// Get the type info object for the afxXM_BaseData class.
        /// </description>
        /// <returns>The type info object for afxXM_BaseData</returns>
