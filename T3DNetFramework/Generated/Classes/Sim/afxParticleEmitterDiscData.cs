...
namespace T3DNetFramework.Generated.Classes.Sim {    
    public unsafe class afxParticleEmitterDiscData : afxParticleEmitterData {
        ...
        public afxParticleEmitterDiscData(string pName, bool pRegister) 
            : this(false) {
            Name = pName;
            if (pRegister) {
                RegisterObject();
        ...
        public afxParticleEmitterDiscData(string pName) 
            : this(pName, false) {
        }
        ...
        public afxParticleEmitterDiscData(SimObject pObj) 
            : base(pObj) {
        }
        
        public afxParticleEmitterDiscData(IntPtr pObj) 
            : base(pObj) {
        }
                    ...
                    _StaticGetTypeFunc =
                        (_StaticGetType)Marshal.GetDelegateForFunctionPointer(
                            Torque3D.DllLoadUtils.GetProcAddress(
                                ...
                                "fnafxParticleEmitterDiscData_staticGetType"), typeof(_StaticGetType));
                }
                ...
                if (_CreateFunc == null) {
                    _CreateFunc =
                        (_Create)Marshal.GetDelegateForFunctionPointer(
                            Torque3D.DllLoadUtils.GetProcAddress(
                                Torque3D.Torque3DLibHandle,
                                "fnafxParticleEmitterDiscData_create"), typeof(_Create));
                }
