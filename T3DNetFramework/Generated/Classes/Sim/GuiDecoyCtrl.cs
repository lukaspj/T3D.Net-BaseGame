...
namespace T3DNetFramework.Generated.Classes.Sim {    
    public unsafe class GuiDecoyCtrl : GuiControl {
        ...
        public GuiDecoyCtrl(string pName, bool pRegister) 
            : this(false) {
            Name = pName;
            if (pRegister) {
                RegisterObject();
        ...
        public GuiDecoyCtrl(string pName) 
            : this(pName, false) {
        }
        ...
        public GuiDecoyCtrl(SimObject pObj) 
            : base(pObj) {
        }
        
        public GuiDecoyCtrl(IntPtr pObj) 
            : base(pObj) {
        }
                    ...
                    _StaticGetTypeFunc =
                        (_StaticGetType)Marshal.GetDelegateForFunctionPointer(
                            Torque3D.DllLoadUtils.GetProcAddress(
                                ...
                                "fnGuiDecoyCtrl_staticGetType"), typeof(_StaticGetType));
                }
                ...
                if (_CreateFunc == null) {
                    _CreateFunc =
                        (_Create)Marshal.GetDelegateForFunctionPointer(
                            Torque3D.DllLoadUtils.GetProcAddress(
                                Torque3D.Torque3DLibHandle,
                                "fnGuiDecoyCtrl_create"), typeof(_Create));
                }
