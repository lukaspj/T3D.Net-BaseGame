...
namespace T3DSharpFramework.Generated.Classes.Sim {    
    ...
    public unsafe class AnimationComponent : Component {
        ...
        new internal struct InternalUnsafeMethods {
                ...
                [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
                [return: MarshalAs(UnmanagedType.I1)]
                //internal delegate bool _SetThreadAnimation(IntPtr _this, int slot, string name);
                ...
                [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
                [return: MarshalAs(UnmanagedType.I1)]
                //internal delegate bool _PlayThread(IntPtr _this, int slot, string name, [MarshalAs(UnmanagedType.I1)]bool transition, float transitionTime);
