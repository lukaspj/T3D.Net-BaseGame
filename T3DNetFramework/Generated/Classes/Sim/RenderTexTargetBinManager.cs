...
namespace T3DNetFramework.Generated.Classes.Sim {    
    public unsafe class RenderTexTargetBinManager : RenderBinManager {
        ...
        public RenderTexTargetBinManager(string pName, bool pRegister) 
            : this(false) {
            Name = pName;
            if (pRegister) {
                RegisterObject();
        ...
        public RenderTexTargetBinManager(string pName) 
            : this(pName, false) {
        }
        ...
        public RenderTexTargetBinManager(SimObject pObj) 
            : base(pObj) {
        }
        
        public RenderTexTargetBinManager(IntPtr pObj) 
            : base(pObj) {
        }
                    ...
                    _StaticGetTypeFunc =
                        (_StaticGetType)Marshal.GetDelegateForFunctionPointer(
                            Torque3D.DllLoadUtils.GetProcAddress(
                                ...
                                "fnRenderTexTargetBinManager_staticGetType"), typeof(_StaticGetType));
                }
