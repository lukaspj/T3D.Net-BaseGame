...
namespace T3DNetFramework.Generated.Classes.Sim {
    ...
    public unsafe class afxXM_LocalOffsetData : afxXM_WeightedBaseData {
        ...
        public afxXM_LocalOffsetData(string pName, bool pRegister) 
            : this(false) {
            Name = pName;
            if (pRegister) {
                RegisterObject();
        ...
        public afxXM_LocalOffsetData(string pName) 
            : this(pName, false) {
        }
        ...
        public afxXM_LocalOffsetData(SimObject pObj) 
            : base(pObj) {
        }
        
        public afxXM_LocalOffsetData(IntPtr pObj) 
            : base(pObj) {
        }
                    ...
                    _StaticGetTypeFunc =
                        (_StaticGetType)Marshal.GetDelegateForFunctionPointer(
                            Torque3D.DllLoadUtils.GetProcAddress(
                                ...
                                "fnafxXM_LocalOffsetData_staticGetType"), typeof(_StaticGetType));
                }
                ...
                if (_CreateFunc == null) {
                    _CreateFunc =
                        (_Create)Marshal.GetDelegateForFunctionPointer(
                            Torque3D.DllLoadUtils.GetProcAddress(
                                Torque3D.Torque3DLibHandle,
                                "fnafxXM_LocalOffsetData_create"), typeof(_Create));
                }
        ...
        /// <description>
        /// Get the type info object for the afxXM_LocalOffsetData class.
        /// </description>
        /// <returns>The type info object for afxXM_LocalOffsetData</returns>
        ...
        public Point3F LocalOffset {
            get => GenericMarshal.StringTo<Point3F>(GetFieldValue("localOffset"));
