...
namespace T3DNetFramework.Generated.Classes.Sim {
    /// <summary>A Mooring effect as defined by an afxMooringData datablock.</summary>
    /// <description>
    ...
    public unsafe class afxMooring : GameBase {
        ...
        public afxMooring(string pName, bool pRegister) 
            : this(false) {
            Name = pName;
            if (pRegister) {
                RegisterObject();
        ...
        public afxMooring(string pName) 
            : this(pName, false) {
        }
        ...
        public afxMooring(SimObject pObj) 
            : base(pObj) {
        }
        
        public afxMooring(IntPtr pObj) 
            : base(pObj) {
        }
                    ...
                    _StaticGetTypeFunc =
                        (_StaticGetType)Marshal.GetDelegateForFunctionPointer(
                            Torque3D.DllLoadUtils.GetProcAddress(
                                ...
                                "fnafxMooring_staticGetType"), typeof(_StaticGetType));
                }
                ...
                if (_CreateFunc == null) {
                    _CreateFunc =
                        (_Create)Marshal.GetDelegateForFunctionPointer(
                            Torque3D.DllLoadUtils.GetProcAddress(
                                Torque3D.Torque3DLibHandle,
                                "fnafxMooring_create"), typeof(_Create));
                }
        ...
        /// <description>
        /// Get the type info object for the afxMooring class.
        /// </description>
        /// <returns>The type info object for afxMooring</returns>
