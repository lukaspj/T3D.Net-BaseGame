...
namespace T3DNetFramework.Generated.Classes.Sim {
    ...
    public unsafe class GuiRadioCtrl : GuiCheckBoxCtrl {
        ...
        public GuiRadioCtrl(string pName, bool pRegister) 
            : this(false) {
            Name = pName;
            if (pRegister) {
                RegisterObject();
        ...
        public GuiRadioCtrl(string pName) 
            : this(pName, false) {
        }
        ...
        public GuiRadioCtrl(SimObject pObj) 
            : base(pObj) {
        }
        
        public GuiRadioCtrl(IntPtr pObj) 
            : base(pObj) {
        }
                    ...
                    _StaticGetTypeFunc =
                        (_StaticGetType)Marshal.GetDelegateForFunctionPointer(
                            Torque3D.DllLoadUtils.GetProcAddress(
                                ...
                                "fnGuiRadioCtrl_staticGetType"), typeof(_StaticGetType));
                }
                ...
                if (_CreateFunc == null) {
                    _CreateFunc =
                        (_Create)Marshal.GetDelegateForFunctionPointer(
                            Torque3D.DllLoadUtils.GetProcAddress(
                                Torque3D.Torque3DLibHandle,
                                "fnGuiRadioCtrl_create"), typeof(_Create));
                }
