...
namespace T3DNetFramework.Generated.Classes.Sim {
    ...
    public unsafe class afxEffectBaseData : GameBaseData {
        ...
        public afxEffectBaseData(string pName, bool pRegister) 
            : this(false) {
            Name = pName;
            if (pRegister) {
                RegisterObject();
        ...
        public afxEffectBaseData(string pName) 
            : this(pName, false) {
        }
        ...
        public afxEffectBaseData(SimObject pObj) 
            : base(pObj) {
        }
        
        public afxEffectBaseData(IntPtr pObj) 
            : base(pObj) {
        }
                    ...
                    _StaticGetTypeFunc =
                        (_StaticGetType)Marshal.GetDelegateForFunctionPointer(
                            Torque3D.DllLoadUtils.GetProcAddress(
                                ...
                                "fnafxEffectBaseData_staticGetType"), typeof(_StaticGetType));
                }
                ...
                if (_CreateFunc == null) {
                    _CreateFunc =
                        (_Create)Marshal.GetDelegateForFunctionPointer(
                            Torque3D.DllLoadUtils.GetProcAddress(
                                Torque3D.Torque3DLibHandle,
                                "fnafxEffectBaseData_create"), typeof(_Create));
                }
