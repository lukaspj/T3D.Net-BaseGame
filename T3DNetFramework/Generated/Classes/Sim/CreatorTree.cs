...
namespace T3DSharpFramework.Generated.Classes.Sim {    
    ...
    public unsafe class CreatorTree : GuiArrayCtrl {
        ...
        new internal struct InternalUnsafeMethods {
                ...
                //internal delegate int _GetParent(IntPtr _this, int nodeValue);
                ...
                //internal delegate IntPtr _GetValue(IntPtr _this, int nodeValue);
                ...
                //internal delegate IntPtr _GetName(IntPtr _this, string item);
                ...
                //internal delegate bool _IsGroup(IntPtr _this, string group);
                ...
                [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
                [return: MarshalAs(UnmanagedType.I1)]
                //internal delegate bool _FileNameMatch(IntPtr _this, string world, string type, string filename);
                ...
                //internal delegate int _AddItem(IntPtr _this, int group, string name, string value);
                ...
                //internal delegate int _AddGroup(IntPtr _this, int group, string name, string value);
